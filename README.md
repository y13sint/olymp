...
|--------|-----------|----------|
| Auth | 7 | Регистрация, авторизация, токены, смена пароля |
| Menu | 4 | Меню на неделю/дату, отзывы на блюда |
| Student | 15 | Платежи, заказы, аллергии, предпочтения, отзывы |
| Cook | 12 | Выдачи, склад, продукты, рецептура, заявки |
| Admin | 16 | Статистика, отчёты, меню, пользователи |
| Notifications | 6 | Уведомления |
| Templates | 21 | Шаблоны меню |
